...
TextStyle textStyleHeader = TextStyle(color: textDefault, fontSize: 24, fontFamily: 'DMSans', fontWeight: FontWeight.w500);
TextStyle toggleButtonStyle = const TextStyle( fontSize: 14, fontFamily: 'DMSans', fontWeight: FontWeight.w400);
TextStyle textStyleShaded = TextStyle(fontSize: 16, fontWeight: FontWeight.w500, fontFamily: 'DMSans', color: textShaded,);
TextStyle textStyleWhite = TextStyle(fontSize: 16, fontWeight: FontWeight.w500, fontFamily: 'DMSans', color: textDefault,);
